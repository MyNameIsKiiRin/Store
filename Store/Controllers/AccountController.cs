...
namespace Store.Controllers
{
    public class AccountController : Controller
    {
        ...
        [HttpPost]
        public ActionResult EditUser(ThanhVien tv)
        {
            var val = db.ThanhViens.Find(tv.MaThanhVien);
            val.HoTen = tv.HoTen;
            val.SoDienThoai = tv.SoDienThoai;
            val.DiaChi = tv.DiaChi;
            db.SaveChanges();
            return RedirectToAction("UserInfo", "Account");
        }
